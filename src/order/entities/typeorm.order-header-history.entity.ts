...
@Entity({ name: 'order_header_hist' })
export class TypeOrmOrderHeaderHistoryEntity {
  @PrimaryColumn()
  readonly id: number;
  ...
  @OneToMany(() => TypeOrmOrderItemHistoryEntity, (items) => items.header)
  readonly items?: TypeOrmOrderItemHistoryEntity[];

  @OneToMany(() => TypeOrmDeliveryHeader, (delivery) => delivery.order)
  readonly deliveries?: TypeOrmDeliveryHeader[];

  @ManyToOne(
    () => TypeOrmCustomerShippingAddress,
    (shippingAddress) => shippingAddress.orderHistories,
  )
  ...
  @OneToMany(
    ...
    (tracking) => tracking.orderHistory,
  )
  ...
  @OneToOne(() => TypeOrmOrderHeaderMainEntity, (main) => main.history)
  readonly main?: TypeOrmOrderHeaderMainEntity;

  @OneToOne(() => TypeOrmBillingHeaderEntity, (billing) => billing.orderHistory)
