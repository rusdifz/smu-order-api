...
@Entity({ name: 'order_item_dummy' })
export class TypeOrmOrderItemDummyEntity {
  @PrimaryColumn()
  readonly id: number;
  ...
  @ManyToOne(() => TypeOrmOrderHeaderDummyEntity, (header) => header.items)
  @JoinColumn({ name: 'm_order_header_id' })
  readonly header?: TypeOrmOrderHeaderDummyEntity;
