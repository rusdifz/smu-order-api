...
export class TypeOrmOrderHeaderEntity {
  ...
  @OneToMany(() => TypeOrmOrderItemEntity, (items) => items.header)
  ...
  @OneToMany(() => TypeOrmTrackingStatusEntity, (tracking) => tracking.order)
  ...
  @OneToOne(() => TypeOrmOrderHeaderMainEntity, (main) => main.order)
