...
@Entity({ name: 'm_cust_shipto_ws' })
export class TypeOrmCustomerShippingAddressWS {
  ...
  @OneToMany(
    ...
    (orderHeader) => orderHeader.shippingAddressWS,
  )
  ...
  readonly orderHistories?: TypeOrmOrderHeaderEntity;
